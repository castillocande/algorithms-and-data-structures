...
bool test_is_prime() {
  ...
  tests_result &= test_assert("PRUEBA EL NÚMERO -1 NO ES PRIMO", !is_prime(-1));
  tests_result &= test_assert("PRUEBA EL NÚMERO -7 NO ES PRIMO", !is_prime(-7));
  return tests_result;
}
...
bool test_array_of_array_copy() {
  ...
  test_result &= copy[2] == NULL; // TIRA SEGFAULT ACÁ!!!!!!!!!!!!
